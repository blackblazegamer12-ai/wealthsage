          ...
          {FEATURES.map((feat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-3xl p-6 sm:p-7 bg-[#11131a]/95 border border-white/10 hover:border-white/20 transition-all group flex flex-col justify-between relative overflow-hidden shadow-xl"
              >
